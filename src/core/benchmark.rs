...
pub fn format_terminal(b: &ProjectBenchmark) -> String {
    ...
    out.push(format!("  nebula-ctx Benchmark — {}", b.root));
    out.push(sep.to_string());
...
pub fn format_markdown(b: &ProjectBenchmark) -> String {
    ...
    out.push("# nebula-ctx Benchmark Report".to_string());
    out.push(String::new());
    ...
    out.push(String::new());
    out.push(format!(
        "*Generated by nebula-ctx benchmark v{} — https://leanctx.com*",
