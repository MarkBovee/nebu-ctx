...
pub fn print_command_box() {
    ...
    println!("  {d}┌─────────────────────────────────────────────────────────┐{r}");
    println!(
        "  {d}│{r}  {cmd}{b}nebu-ctx gain{r}        {m}Token savings dashboard{r}         {d}│{r}"
    );
    println!(
        "  {d}│{r}  {cmd}{b}nebu-ctx dashboard{r}   {m}Web analytics (browser){r}        {d}│{r}"
    );
    println!(
        "  {d}│{r}  {cmd}{b}nebu-ctx heatmap{r}     {m}Project context heat map{r}        {d}│{r}"
    );
    println!(
    ...
    println!("  {d}│{r}  {cmd}{b}nebu-ctx contribute{r}  {m}Share anonymized compression stats{r}{d}│{r}");
    println!(
