...
fn main() {
    ...
    let out_path = out.unwrap_or_else(nebula_ctx::core::tdd_schema::default_tdd_schema_path);
    let expected = nebula_ctx::core::tdd_schema::tdd_schema_value();
...
fn write_if_changed(path: &Path, content: &str) -> Result<(), String> {
    nebula_ctx::core::tdd_schema::write_if_changed(path, content)
}
