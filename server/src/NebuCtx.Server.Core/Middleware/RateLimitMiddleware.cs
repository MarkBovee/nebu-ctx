...
public sealed class RateLimitMiddleware
{
    ...
    public RateLimitMiddleware(RequestDelegate next, IOptions<ServerOptions> options, ILogger<RateLimitMiddleware> logger)
    {
        var serverOptions = options.Value;
        _next = next;
        _maxRequestsPerSecond = serverOptions.MaxRequestsPerSecond;
        _burstCapacity = serverOptions.RateBurst;
        _logger = logger;
        _tokens = serverOptions.RateBurst;
